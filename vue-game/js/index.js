...
var vm = new Vue({
  ...
  methods: {
    ...
    startRedPacket() {
      ...
      var scales = (Math.random() * (14 - 11 + 1) + 11) * 0.1; // 图片尺寸
      var durTime = Math.random() * (1.8 - 1.5 + 1) + 1.5 + "s"; // 时间  1.2和1.2这个数值保持一样
    ...
    getTicket() {
      this.$http.get("lo.php").then(function(res) {
